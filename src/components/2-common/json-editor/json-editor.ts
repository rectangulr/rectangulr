  ...
  shortcutsForList: Partial<Command>[] = [
    {
      ...
      func: () => {
        ...
        if (length == 0 || this.list.$selectedIndex() == length - 1) {
          ...
          this.list.selectIndex(this.list.$selectedIndex().index + 1)
        }
      },
    },
    {
      ...
      func: key => {
        ...
        if (this.list.$selectedIndex().index == 0) return key
        this.list.selectIndex(this.list.$selectedIndex().index - 1)
      },
    },
    {
      ...
      func: key => {
        if (this.list.$items().length == 0) return key
        if (this.list.$selectedIndex().index == this.list.$items().length - 1) return key
        this.list.selectIndex(this.list.$selectedIndex().index + 1)
      },
    },
    {
